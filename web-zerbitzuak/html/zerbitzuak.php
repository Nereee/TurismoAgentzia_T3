...
<header>
  ...
  <h1>Formularios Dinámicos</h1>
    ...
    <div class="radioak">
      <label>
        <input type="radio" name="form-selector" value="hegoaldia" /> Hegoaldia
      </label>
      <label>
...
<br>
  <div id="hegoaldia" class="form-container">
    <h2>Hegoaldiak</h2>
    <br>
    <form id="hegoaldia-form">
      ...
      <label for="irtera">Irtera:</label><br/>
      ...
      <input type="text" id="iraupena" name="iraupena" required/><br/>
        <div class="radioak">
      <label>
        <input type="radio" name="hegoaldia-type" value="joan" checked/> Joan
      </label>
      <label>
        <input type="radio" name="hegoaldia-type" value="joan-etorri"/> Joan eta Etorri
      </label>
        </div>
      ...
      <br>
      <button type="submit" formmethod="post" formaction="hegoaldi.php" class="form-buton"  id="botoia">Gorde </button>
      <button type="button" onclick="addToTable('hegoaldia')">Añadir a Tabla</button>
    </form>
    <h3>Tabla de Datos Hegoaldiak</h3>
    <table id="hegoaldia-table">
      <thead>
        <tr>
          <th>Bidai Mota</th>
          <th>Aireportua 1</th>
  ...
  <div id="ostatuak" class="form-container">
    ...
    <form id="ostatuak-form">
      ...
      <button type="button" onclick="addToTable('ostatuak')">Añadir a Tabla</button>
      <button type="submit" formmethod="post" formaction="ostatua.php" class="form-buton"  id="botoia">Gorde</button>
    </form>
    <h3>Tabla de Datos Ostatuak</h3>
  ...
  <div id="deskripcion" class="form-container">
    ...
    <form id="deskripcion-form">
      ...
      <button type="button" onclick="addToTable('deskripcion')">Añadir a Tabla</button>
    </form>
    <h3>Tabla de Datos Deskripción</h3>
